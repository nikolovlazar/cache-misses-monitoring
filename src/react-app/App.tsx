...
// Search states
type SearchState = 'idle' | 'loading' | 'success' | 'error' | 'not-found';
...
export default function Home() {
  const [searchQuery, setSearchQuery] = useState('The Matrix');
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (searchState === 'not-found' || searchState === 'error') {
      setSearchState('idle');
      setSearchError(null);
    }
  };
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900'>
      ...
      <main className='container mx-auto px-4 py-8'>
        ...
        {/* Movie Details - Only show when idle or success */}
